...
#define STRING_CONFIG_H_AUTHOR "(FrancoX)" // Original author or contributor.
...
// Desativar pull-ups para evitar conflitos com endstops NC (GPLV3)
#undef ENDSTOPPULLUPS 

// Habilitar pull-downs se necessário (dependendo da eletrônica da placa)
//#define ENDSTOPPULLDOWNS

// Configuração do estado dos endstops (GPLV3 são NC, então ativam em LOW)
#define X_MIN_ENDSTOP_HIT_STATE LOW
#define Y_MIN_ENDSTOP_HIT_STATE LOW
#define Z_MIN_ENDSTOP_HIT_STATE HIGH  // Alterado para HIGH para compatibilidade com BLTouch

// BLTouch no eixo Z (geralmente ativa em HIGH)
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH  // Alterado para HIGH para compatibilidade com BLTouch

// Habilitar interrupções para endstops se suportado pela placa
#define ENDSTOP_INTERRUPTS_FEATURE

// Habilitar detecção de endstops quebrados
#define DETECT_BROKEN_ENDSTOP

// Endstop Noise Threshold (se necessário, ativar para reduzir interferências)
//#define ENDSTOP_NOISE_THRESHOLD 2

// Ativar pull-up específico para o BLTouch
#define ENDSTOPPULLUP_ZMIN

// Definir modo 5V para o BLTouch se necessário
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 525.70 }
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 200, 10, 35 } // ...or, set your own edit limits
#endif
...
#define PROBING_MARGIN_RIGHT 50  // Margem maior na direita devido ao deslocamento do BLTouch
#define PROBING_MARGIN_LEFT 10   // Mantém a margem mínima na esquerda
#define PROBING_MARGIN_FRONT 20  // Mantém a margem mínima na frente
#define PROBING_MARGIN_BACK 10   // Mantém a margem mínima atrás
